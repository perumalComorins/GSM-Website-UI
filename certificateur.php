...
<body>
  ...
  <div id="wrapper">
      ...
      <div id="page-content-wrapper" class="container-fluid reset-padding">
              ...
              <div class="container container-70 reset-padding certificateur-container">
                  <div class="row reset-margin">
                      ...
                      <div class="col-md-6 infobar-section align-self-center">
                            <div class="infobar">
                                ...
                                <h2 class="infobar-title">Seul certificateur</h2>
                            </div>
                      </div>
                  </div>
              </div>
                ...
                <div class="certificateur-content-container">
                    <div class="container container-70 reset-padding">
                        <div class="row mx-0 mb-4">
                            ...
                            <div class="col-md-6 certificateur-image-section">
                                <img src="images/binoculars.png" class="img-fluid"/>
                            </div>
                    ...
                    <div class="ml-align-box certificateur-imgbannerbox">
                        <img src="images/binoculars-for-smartphone-repair.png"  class="img-fluid"/>
          ...
          <section class="Quotebutton site-body-container" style="background-image: url('images/technician-carefully-inspect.png');">
            <div class="Quotebutton__box reset-padding">
                <h1 class="box--title">Le centre de formation</h1>
                <p class="box--para">Le centre de formation de GSM Master est historiquement basé à Paris. 
                ...
                <div class="link__box mt-3">
                   <a href="#" class="btn gsm-bg-white btn-gsm-md">Je veux m’inscrire</a>
                </div>
            </div>
          </section>
