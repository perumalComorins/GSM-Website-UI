        ...
        <div class="col-4 footer-widget reset-padding">
            <div class="row reset-margin">
                ...
                <div class="footerpanelAboutContent">
                    ...
                    <p class="about-description">Present in the mobile telephony market since 1999, GSM Master founded its training center at the end of 2014
                         with the aim of contributing to the standardization of the mobile product repair sector.</p>
                    <span class="footerpanelCopyright">&copy; 2020 GSM Master. All rights reserved</span>
                </div>
            </div>
        </div>
        <div class="col-4 footer-widget reset-padding">
