                ...
                <div class="navbarMenu-col reset-padding">
                    ...
                    <nav class="sidenav-Menu">
                      <ul>
                        ...
                        <li><a href="qualified_staff.php">Demande de devis</a></li>
                        <li><a href="recritment.php">GSM Recrute</a></li>
                        <li><a href="contact-faq.php">Contact & FAQ</a></li>
                      </ul>
                    </nav>

                    <div class="course_Section mt-5 d-none d-lg-block">
                        <a href="individual.php" class="applyTag individualColor"><img src="images/cornershadow.png" />Individual</a>
