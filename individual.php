              ...
              <div class="banner-cover-overlay">
                  <div class="banner-cover individual-banner-content">
                      <div class="container container-1140 reset-padding banner-title-blog">
                        <h2 class="banner-title">Réussir grâce aux compétences du futur</h2>
                      </div>
                  </div>
              </div>
          </div>
          ...
          <section class="site-body-container">
              <div class="registeration-box">
                  ...
                  <div class="container container-70 reset-padding text-center register-box-bottom">
                      <h2 class="section-title individual-text">Développe tes talents pour intégrer les équipes de demain</h2>
              ...
              <div class="training-initial-formSection">
                  <div class="container container-70 reset-padding">
                      <h3 class="train-title individual-text text-center">Prêt à vous former ?</h3>
                      <div class="register-section">
                          <h3 class="reg-session-title individual-text">Inscrivez-vous à la prochaine session</h3>
                          <form class="register-initial-form">
                            <div class="form-row twospaces-row reset-margin">
                                <div class="form-group gsm-form-group col-md-6">
                                  <label class="gsm-form-label individual-text">Choisissez votre formation</label>
